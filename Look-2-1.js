...
const zqbody = require("./Cohc-2-1/zqrw1.json");
...
!(async () => {
    ...
    $.log(`${zqbody.user} 共提供了${startArr.length}次浏览赚任务`)
    ...
    $.log(`\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n${zqbody.user}共提供${lookArr.length}次看看赚任务\n`)
    if (lookArr.length !== 0) {
		$.index=0;
    ...
    console.log(`${zqbody.user}共提供了${searchArr.length}此搜索赚任务`)
