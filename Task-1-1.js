...
//json文件，改成你的名字
const zqbody = require("./Cohc-1-1/Task.json");
...
function runRotary(index) {
    ...
    return new Promise((resolve, reject) => {
        ...
        $.post(url, (error, response, data) => {
			...
			console.log(`抽奖数据：${JSON.stringify(rotaryresp)}\n`)
